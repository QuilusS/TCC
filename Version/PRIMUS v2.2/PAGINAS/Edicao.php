...
<body>
    ...
    <div class="button-group">
            <button class="criar-btn" onclick="openForm()">Criar Produtos</button>
            <button class="gerenciar-categorias-btn" onclick="openCategoryManager()">Gerenciar Categorias</button>
        </div>
        <div id="formOverlay" class="form-overlay" onclick="closeAllPopups()">
            <div id="productForm" class="form-popup" onclick="event.stopPropagation()">
            ...
            <div id="categoryManager" class="form-popup" onclick="event.stopPropagation()">
