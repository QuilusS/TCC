        ...
        <div class="Principais">
            <div class="container">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-6 hidden"><img src="../IMGS/FotoFrenti.jpg" alt="Foto De Frente" class="SeguImg"></div>
                </div>
    
                <br><br>
    
                <div class="row g-0">
                    <div class="col-6 hidden2"><img src="../IMGS/FotoFrenti.jpg" alt="Foto De Frente" class="TerciImg" ></div>
