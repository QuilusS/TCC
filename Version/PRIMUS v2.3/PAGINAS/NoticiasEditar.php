        ...
        <div class="row align-items-center g-0">
            <div class="col-4">
                <div class="FundoForm">
                    ...
                    <input type="text" id="titulo" name="titulo" maxlength="70" required placeholder="A Importância do Óleo de Motor para a Vida Útil do Seu Carro" value="<?php echo htmlspecialchars($titulo); ?>">
