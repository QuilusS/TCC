...
<body>
    ...
    $titulo = $categoria = $descricao = $texto = $imagemCapa = $imagem = '';
...
?>
        ...
        <div class="row align-items-center g-0">
            <div class="col-4">
                <div class="FundoForm">
                    ...
                    <input type="text" id="titulo" name="titulo" required placeholder="A Importância do Óleo de Motor para a Vida Útil do Seu Carro" value="<?php echo htmlspecialchars($titulo); ?>">

                    <div class="container">
                        <div class="row justify-content-center align-items-end g-4">
                            <div class="col-4 d-flex flex-column align-items-center">
                                <label class="nowrap-label"><i class="fa fa-image"></i>&nbsp;Imagem<br>da capa:</label>
                                <div style="position: relative; width: 100%;">
                                    <input type="file" id="imagemCapa" name="imagemCapa" accept="image/*" <?php echo empty($imagemCapa) ? 'required' : ''; ?>>
                                    <label class="BotaoImagem" id="btnImagemCapa"></label>
                                </div>  
                            </div>
                            <div class="col-4 d-flex flex-column align-items-center">
                                <label for="categoria"><i class="fa-solid fa-tags"></i> Categoria:</label>
                                <input type="categoria" id="categoria" name="categoria" placeholder="Dica" required value="<?php echo htmlspecialchars($categoria); ?>">
                            </div>
                            <div class="col-4 d-flex flex-column align-items-center">
                                <label class="nowrap-label"><i class="fa fa-image"></i>&nbsp;Imagem<br>da notícia:</label>
                                <div style="position: relative; width: 100%;">
                                    <input type="file" id="imagem" name="imagem" accept="image/*" <?php echo empty($imagem) ? 'required' : ''; ?>>
                    ...
                    &#10;Lembre-se de verificar o nível de óleo regularmente e seguir o intervalo de troca recomendado para garantir o máximo desempenho e vida útil do seu motor."><?php echo htmlspecialchars($descricao); ?></textarea>
            ...
            <div class="col-4 d-grid justify-content-center align-items-center">
                ...
                <img src="../IMGS/ImagemExemploFundo.png" alt="ImagemExemplo" class="ImagemExemplo">
            </div>
    ...
    <script>
        // Passa os nomes dos arquivos do PHP para o JS
        var nomeImagemCapa = "<?php echo $imagemCapa ? basename($imagemCapa) : ''; ?>";
        var nomeImagem = "<?php echo $imagem ? basename($imagem) : ''; ?>";
    </script>
    <script src="../JAVASCRIPT/jsEditarNoticias.js"></script>
