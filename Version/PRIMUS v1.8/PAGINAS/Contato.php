            ...
            <div class="row">
                ...
                <div class="Formulario col-lg-6 col-12">
                    ...
                    <form id="MyFormulario" autocomplete="off">
                        ...
                        <input type="text" name="nomeCompleto" id="name" placeholder="Nome Completo">
                        <p id="MensagemErro" style="display: none;"><i class="fa-solid fa-triangle-exclamation"></i>&nbsp;Campo obrigatório. Coloque seu nome completo.</p>

                        <input type="text" id="emailAtendi" name="emailContato" placeholder="Email">
                        <p id="MensagemErro2" style="display: none;"><i class="fa-solid fa-triangle-exclamation"></i>&nbsp;Campo obrigatório. Coloque seu email.</p>
        
                        <input type="text"  id="telefone" name='telefone' placeholder="Telefone: __*_________" maxlength="11">
