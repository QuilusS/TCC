        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="Secao2 col-lg-6 col-12">
                    <img src="../IMGS/Primusantiga.jpg" alt="FotoPrimusAntiga" class="img-fluid" onclick="ImagemMaior()">
                </div>

                <div id="EfeitoOverlay" class="overlay">
                    <img src="../IMGS/Primusantiga.jpg" alt="FotoPrimusAntiga" class="img-fluid Tamanhos">
                </div>
            ...
            <div class="row g-5">
                ...
                <div class="Secao2 col-lg-6 col-12">
                    <img src="../IMGS/Equipe_Primus_Cortada.png" alt="Equipe" class="img-fluid" onclick="ImagemMaior3()">
                </div>

                <div id="EfeitoOverlay3" class="overlay">
                    <img src="../IMGS/Equipe_Primus_Cortada.png" alt="Equipe" class="img-fluid Tamanhos">
                </div>
